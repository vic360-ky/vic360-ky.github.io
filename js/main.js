...
/* ── Semantic synonym map ──────────────────────
   ...
   ─────────────────────────────────────────────── */
const synonyms = {
  'coding':            ['python','c++','javascript','html','matlab','claude code','git','github','replit'],
  'code':              ['python','c++','javascript','html','matlab','claude code','git','github','replit'],
  'programming':       ['python','c++','javascript','html','matlab','claude code','replit'],
  ...
  'design':            ['solidworks','fusion 360','autocad','figma','process design','organizational design', 'prototyping', 'trade-off analysis'],
  'hardware':          ['altium','solidworks','fusion 360','autocad','fea'],
  'circuit':           ['altium'],
  'electronics':       ['altium'],
  'pcb':               ['altium'],
  'simulation':        ['matlab','fea'],
  'engineering':       ['solidworks','fusion 360','autocad','altium','matlab','fea','c++', 'prototyping'],
  'mechanical':        ['solidworks','fusion 360','autocad','fea'],
  'data':              ['matlab','python','power bi','excel','google sheets','market research'],
  'analytics':         ['power bi','excel','matlab','python','google sheets'],
  ...
  'ai':                ['claude code','python','prompt engineering'],
  'llm':               ['prompt engineering'],
  'automation':        ['prompt engineering'],
  'generative':        ['prompt engineering'],
  'prompting':         ['prompt engineering'],
  'project management':['agile','scrum','asana','confluence','project tracking','pmp','jira', 'requirements management', 'schedule management'],
  'pm':                ['agile','scrum','project tracking','pmp','process design'],
  'methodology':       ['agile','scrum','lean','six sigma','pmp','pmlc'],
  'methodologies':     ['agile','scrum','lean','six sigma','pmp','pmlc'],
  'project lifecycle': ['pmlc', 'schedule management'],
  ...
  'efficiency':        ['lean','six sigma','process design', 'schedule management'],
  ...
  'planning':          ['agile','scrum','project tracking','pmp','process design','pmlc','prioritization frameworks'],
  'tracking':          ['project tracking','budget tracking','asana','confluence','jira'],
  'budget':            ['budget tracking'],
  'finance':           ['budget tracking','excel'],
  'financial':         ['budget tracking','excel'],
  'procurement':       ['vendor management','budget tracking'],
  'vendor':            ['vendor management'],
  'ticketing':         ['servicenow','confluence','asana','jira'],
  'jira':              ['jira'],
  'itsm':              ['servicenow'],
  'documentation':     ['confluence','sharepoint','notion','knowledge management','sop development', 'contract management'],
  'docs':              ['confluence','sharepoint','notion','knowledge management','sop development'],
  ...
  'management':        ['stakeholder management','vendor management','budget tracking','knowledge management','organizational design', 'contract management', 'schedule management', 'risk management'],
  'managing':          ['stakeholder management','vendor management','budget tracking'],
  'stakeholder':       ['stakeholder management','executive communication', 'contract management'],
  'conflict':          ['conflict resolution', 'trade-off analysis'],
  ...
  'collaboration':     ['cross-functional leadership','stakeholder management','confluence','google sheets','github'],
  'repository':        ['github'],
  'github':            ['github'],
  'development':       ['replit'],
  'cloud':             ['replit'],
  'ide':               ['replit'],
  'replit':            ['replit'],
  'analysis':          ['market research','google sheets'],
  'research':          ['user testing','market research','human-centered design'],
  ...
  'decision making':   ['prioritization frameworks'],
