...
const synonyms = {
  ...
  'project management':['agile','scrum','asana','confluence','project tracking','pmp','jira'],
  ...
  'jira':              ['jira'],
  'itsm':              ['servicenow'],
  'documentation':     ['confluence','sharepoint','notion','knowledge management','sop development'],
